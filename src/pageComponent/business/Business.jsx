  ...
  return (
    <div className="container">
      ...
      {/* <div className="counters">
          <Counter count='250' para='Successful Project' />
          <Counter count='400' para='Successful Project' />
          <Counter count='120' para='Successful Project' />
          <Counter count='100' para='Successful Project' />
      </div> */}
    </div>
  );
};
